...
int sc_main(int argc, char **argv) {
	...
	core0.init(instr_mem_if0, data_mem_if0, &clint, entry_point, rv32_align_address(opt.mem_end_addr - 3));
	core1.init(instr_mem_if1, data_mem_if1, &clint, entry_point, rv32_align_address(opt.mem_end_addr - 32767));
